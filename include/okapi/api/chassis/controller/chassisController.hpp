...
class ChassisController {
   ...
   * moveDistance and turnAngle both use closed-loop control to move the
   * robot. There are passthrough functions for everything defined in
   * ChassisModel.
   *
  ...
  /**
   * Sets the target distance for the robot to drive straight (using
   * closed-loop control).
   *
   * @param itarget distance to travel
   */
